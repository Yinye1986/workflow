...
---
vim.keymap.set({ "n", "v" }, "<C-n>", "b", { noremap = true, silent = true })
vim.keymap.set({ "n", "v" }, "<C-e>", "6j", { noremap = true, silent = true })
vim.keymap.set({ "n", "v" }, "<C-i>", "6k", { noremap = true, silent = true })
vim.keymap.set({ "n", "v" }, "<C-o>", "w", { noremap = true, silent = true })
---
...
vim.keymap.set("i", '<C-o>', '<Right>', { noremap = true, silent = true })

--- 代码移动 ---
vim.keymap.set("v", "N", "<gv", { noremap = true, silent = true })
vim.keymap.set("v", "E", ":m '>+1<CR>gv=gv", { noremap = true, silent = true })
vim.keymap.set("v", "I", ":m '<-2<CR>gv=gv", { noremap = true, silent = true })
vim.keymap.set("v", "O", ">gv", { noremap = true, silent = true })
...
--- 模式切换 ---
vim.keymap.set({ "v", "i" }, "<C-'>", '<Esc>', { noremap = true, silent = true })
---
vim.keymap.set("n", "ai", "i", { noremap = true, silent = true })
